...
<div class="container">
	...
	<h2 style="color:#95f442;">Welcome to Admin Login</h2>
	</div>
</div>
<div class="container">
<div class="row" >
  ...
  <div class="panel-body">
  	<div><p id="login_fail" style="color:red;font-weight: bold;"></p></div>
 					 ...
 					 <div class="form-group">
			    		    <input class="form-control" placeholder="email" name="admin_email" type="email" required>
			    		</div>
			    			<div class="form-group">
			    			<input class="form-control" placeholder="Password" name="admin_pass" type="password" required>
			    		
			    		</div>
			    		<button type="submit" name="admin_submit" value="admin_submit" class="btn btn-info btn-large">Login</button>
			    		</fieldset>
  ...
  <div class="panel-footer">
	...
	function test_input($data) {
		...
		if(isset($_POST['admin_submit'])){
		 $adminemail = test_input($_POST['admin_email']);

		 $adminpass = test_input($_POST['admin_pass']);
		

		$sel_admin="select * from admin where admin_email='$adminemail' AND admin_pass='$adminpass'";
