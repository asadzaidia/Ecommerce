...
<?php cart();?>
      ...
      $product_id=$_GET['product_id'];
          ...
          $get_products_details="select * from products where p_id='$product_id'";

          $run_products=mysqli_query($conn,$get_products_details);
          ...
          $p_img2=$row_products['p_img2'];
        $p_img3=$row_products['p_img3'];
            echo"
    ...
    <h1 style='font-weight:bold;font-size:17px;color:green;'>$p_title</h1>
      ...
      <div class='caption'>
        <h3 style='font-weight:bold; font-size:15px;'>$p_desc</h3>
         <a href='index.php' class='btn btn-primary' role='button'><span style='font-weight:bold; font-family:Verdana'>Go Back</span></a> 
  ...
  <div class='col-md-5'>
    ...
    <div class='thumbnail'>
      ...
      <img src='admin_area/product_images/$p_img2' alt='$p_title' /> 
      <br />
      <img src='admin_area/product_images/$p_img3' alt='$p_title' /> 
    ...
    <div class="col-md-12">
        <div class="page-header">
          ...
          <h1 style="color:blue;float:center;font-weight: bold;font-size: 24px;font-family: cursive;">Product Description:</h1>
        </div>
        </div></div>
      </div>
